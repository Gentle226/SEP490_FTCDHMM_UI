    ...
    <Card className="rounded-tl-lg border-0 pt-0 pb-6 shadow-md">
      ...
      <CardContent className="px-12 pt-4">
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Weight */}
          <div>
            <Label htmlFor="weightKg" className="flex items-center gap-2 font-medium text-gray-900">
          ...
          {/* Height */}
          <div>
            <Label htmlFor="heightCm" className="flex items-center gap-2 font-medium text-gray-900">
